...
//        App.
    public class BackendDummy implements BackendInterface {
        ...
        public List<String> getAvgRatings() {
            return Arrays.asList(new String[]{"1", "3", "4"});
        }
        ...
        public List<MovieInterface> getThreeMovies(int startingIndex) {
            ...
            movies.add(new MovieInterface() {
                public String name = "Plan 9 from Outer Spacce";
                @Override
            ...
            movies.add(new MovieInterface() {
                public String name = "cool math games";
                @Override
                public String getTitle() {
                    return "Cool math games";
                }
                @Override
                public Integer getYear() {
                    return 2020;
