...
public class TestMovieAndMovieDataReader {
    ...
    /**
     * This test reads in 3 directors and tests whether the list of movies
    ...
    public boolean testReaderMovieDirector() {
      ...
      // true if the three movies have the right director
      return equalOne;
    }
    /**
     * This test reads in 3 descriptions and tests whether the list of movies
    ...
    public boolean testReaderMovieDescription() {
      ...
      // true if the three movies have the right description
      return equalOne;
    }
}