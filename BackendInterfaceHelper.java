 ...
 *
 */
public class BackendInterfaceHelper extends HashTableMap<String, LinkedList<MovieInterface>> implements BackendInterface {
...
//		System.out.println();
//	}
	private MovieDataReaderDummy movieHelper;
...
//	private List<String> AvgRtgList;
	...
	public BackendInterfaceHelper(String[] args) {
		...
		try {
			...
			for (int i = 0; i < movieArray.size(); i++) {
				...
				if (!ratingTable.containsKey(rating)) {
					ratingTable.put(rating, new LinkedList<MovieInterface>());
				}
				// adds it
	 ...
	 * 
	 */
	public BackendInterfaceHelper(Reader file) {
